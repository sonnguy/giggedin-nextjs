...
const Layout = ({ header, children, experience }) => {
...
})(window,document,'script','dataLayer','GTM-NW4FF6R');`}} /> */}
				<noscript dangerouslySetInnerHTML={{
					__html: `<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NW4FF6R"
